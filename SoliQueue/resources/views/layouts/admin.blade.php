    ...
    <div id="application-sidebar"
        ...
        <nav class="p-0 w-full flex flex-col flex-wrap">
            <ul class="space-y-1">
                ...
                <li>
                    <a class="w-full flex items-center gap-x-3.5 py-3 px-6 text-sm font-bold transition-all {{ request()->routeIs('admin.entretiens.index') ? 'bg-primary/10 text-white border-l-4 border-primary' : 'text-slate-400 hover:text-white border-l-4 border-transparent hover:bg-slate-800/50' }}"
                        href="{{ route('admin.entretiens.index') }}">
                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li>
                    <a class="w-full flex items-center gap-x-3.5 py-3 px-6 text-sm font-bold transition-all {{ request()->routeIs('admin.salles.index') ? 'bg-primary/10 text-white border-l-4 border-primary' : 'text-slate-400 hover:text-white border-l-4 border-transparent hover:bg-slate-800/50' }}"
